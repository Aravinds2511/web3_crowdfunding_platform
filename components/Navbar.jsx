                                        ...
                                        <div>
                                            <a
                                              ...
                                              class="inline-flex items-center">
                                                ...
                                                <span class="ml-2 text-xl font-bold tracking-wide textgray-800 uppercase">
                                                    Crwfunds
                                                </span>
                                              </a>
                                        </div>
                                    ...
                                    <nav>
                                        <ul class="space-y-4">
                                            ...
                                            <li>
                                                <a
                                                 href="/"
                                                 class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-full shadow-md transition duration-300 transform hover:scale-105 hover:shadow-lg"
                                                 aria-label="Sign up"
                                                 title="Sign up">
                                                    Connect Wallet
                                                 </a>
